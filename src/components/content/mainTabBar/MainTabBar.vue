<template>
  <tab-bar>
    ...
    <tab-bar-item path="/category" activeColor="#FF0000">
      <img slot="item-icon" src="~assets/img/tabbar/cotegory.svg" />
      <img slot="item-icon-active" src="~assets/img/tabbar/cotegory_active.svg" />
      <div slot="item-text">分类</div>
    </tab-bar-item>
    <tab-bar-item path="/shopcart" activeColor="#FF0000">
